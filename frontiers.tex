...
pathogens \cite{liu_dynamics_2020,rose_persistence_2020}. This distance threshold defines the degree of genetic closeness required between pathogen sequences, isolated from two individuals, to suggest them as potential transmission partners in the network. Using a
