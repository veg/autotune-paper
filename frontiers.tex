...
with 0.76\% and 0,19\% thresholds, at scores 1.137 and 1.030, respectively. It
is notable that in these networks, DWH estimates for PWID rise dramatically.
However, both AUTO-TUNE optimized thresholds yield DWH estimates for all risk
factors that are significantly greater than 0. This suggests that these
...
\TODO{Add text to interpret the table.}

When using AUTO-TUNE, two separate ranges appear. \TODO{Add text to interpret the
table.}

\TODO{Mention whether or not DWH estimates were significantly different from 0}
