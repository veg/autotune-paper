...
construct longitudinal transmission networks. Using AUTO-TUNE, no distance
threshold received a score above $1.9$, but using the default $1.5\%$ threshold
is clearly suboptimal. The $1.5\%$ distance threshold received an AUTO-TUNE
score of $0.029$.
