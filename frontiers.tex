...
degree-weighted homophily (DWH) score across 3-year collection date windows, as
that is the metadata that was consistently available across all three datasets.
