...
bacterial DNA, allows the detection of genetic fingerprints. These fingerprints
can be targeted for epidemiological studies over short time periods
\cite{paraskevis_application_2016}. The selection of a genetic distance
threshold becomes particularly important in this context. Depending on the
disease and its context of spread, the threshold may vary. For instance, a
highly contagious respiratory illness may require a smaller genetic distance
threshold than a less contagious illness primarily spread through direct
contact.
