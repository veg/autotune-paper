...
(obtained by deep sequecing) as a lower bound for the threshold, or tune $D$ to
...
several with publically available sequence data.  
...
making a joint analysis challenging. As with HIV-1, AUTOTUNE returns a wide
...
variability -- information not available to AUTOTUNE.
