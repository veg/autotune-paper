...
various pathogens has taken off in the past two decades, with applications to a
...
\citep{thoma_challenge_2022}, just to mention some. Notably, genomic
...
\citep{von_rotz_systematic_2023,campigotto_utility_2023}. On the whole,
...
methodology's independence from supplementary data makes it robust to
...
using the Tamura-Nei (TN93) \citep{tamura_estimation_1993} approach, with a
...
co-circulating in the infected individual at the time of sampling.
...
would be expected by chance \citep{golub_how_2012}. DWH is calculated as the
...
Tennessee, Seattle, and Alberta, were processed using the workflow prescribed
...
Max. Alternatively, the tree inference step alone with clustuneR takes several hours to
complete.
