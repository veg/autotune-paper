...
the original network that clustered in the subsampled networks. Please see
Figure~\ref{fig:subsampling2}.
...
Since the thresholds inferred by AUTO-TUNE for the subsampled networks
were larger than the "fully" sampled network, we also measured the impact of
thresholding on the network's nodes that were originally singletons. Across
the variations in subsampling rates, the proportion of sampled singletons that
clustered 

\ref{fig:subsampling2}
