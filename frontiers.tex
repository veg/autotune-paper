...
\begin{abstract}
  ...
  making it difficult to interpret and analyze\TODO{HV: I'd clarify that a high
  distance threshold results in a larger network as well, not just a more
  densely connected one.}. On the other hand, using a distance threshold that
