...
\hline
\end{tabularx}
\caption{AUTO-TUNE values with data from \citep{rhee_national_2019}}
\label{table:rhee}
\end{table}
...
\hline
\end{tabularx}
  \caption{Comparison of DWH values for different countries with 1.5\% and AUTO-TUNE inferred threshold of 1.6\% for \cite{rhee_national_2019}.}
